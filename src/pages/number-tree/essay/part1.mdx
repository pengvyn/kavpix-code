...
This article is for the [Expression Calculator](/number-tree/expression-calculator), make sure to play around with that so that the article makes sense.
...
This article is made up of 10 mini-articles, but I've divided it into 2 sections, the first one is about the visualization of the tree, and the second one is about the code. All the code for this project is open-source [on github](https://github.com/pengvyn/kavpix-code)
